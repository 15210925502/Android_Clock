...
public class Lunar {
    ...
    public static String getLunar1(Date date) {
        String s;
        //日期
        Lunar1(date); //农历
        s = "农历 ";
    ...
    public static  String getLunar2(Date date){
        String s = null;
        //日期
        Lunar1(date); //农历
        int sy = (getYear() - 4) % 12;
        s = "【" + Animals[sy] + "】" + cYear(getYear()) + "年" + "   ";
...
//    获取阳历日期
    public static String getYangLiLunar(Date date,String formatStr){
        //获取当前时间
//        Date date = new Date(System.currentTimeMillis());
    ...
    private static String lunarFormat(){
        String s;
        int sy = (getYear() - 4) % 12;
